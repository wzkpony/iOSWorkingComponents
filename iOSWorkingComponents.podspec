...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/wzkpony/iOSWorkingComponents.git", :tag => "0.1.7" }
...
#Categories目录
    ...
    ss.source_files = 'iOSWorkingComponents/iOSWorkingComponents/Components/Categories/**/*.{h,m}','iOSWorkingComponents/iOSWorkingComponents/Components/Categories/*.{h,m}'
    end
