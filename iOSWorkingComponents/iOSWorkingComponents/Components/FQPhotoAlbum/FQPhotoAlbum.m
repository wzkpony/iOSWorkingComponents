...
//                 return;
            ...
            [self startChoose:self->_sourceType];
        }
...
- (void)getPhotoAlbumOrTakeAPhotoWithController:(UIViewController *)viewController onlyOpenCamera:(BOOL)onlyOpenCamera andWithBlock:(PhotoBlock)photoBlock {
