...
#define FTDefaultTintColor                  [UIColor colorWithRed:255/255.f green:255/255.f blue:255/255.f alpha:1.f]
#define FTDefaultTextColor                  [UIColor colorWithRed:60/255.0 green:60/255.0 blue:60/255.0 alpha:1/1.0]
...
- (NSString *)filePathForImageURL:(NSURL *)url {
    NSString *diskCachePath = [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) firstObject] stringByAppendingPathComponent:FTPopOverMenuImageCacheDirectory];
